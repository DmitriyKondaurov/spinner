...
!function (t, i, e, s) {
    ...
    !function () {
        ...
        render: function () {
            ...
            this.visibility = this.boxOffsetBottom > t && this.boxOffsetTop < e ? "visible" : "visible", this.mirrorTop = this.boxOffsetTop - t, this.mirrorLeft = this.boxOffsetLeft - i, this.offsetTop = this.offsetBaseTop - this.mirrorTop * (1 - this.speed), this.$mirror.css({
                ...
                height: '100%', //_____________  my custom fix
                width: 'auto'  //_____________  my custom fix
            })
        }
    }), t.extend(o, {
        scrollTop: 0,
